...
let configOptions = {
  ...
  search: {
    ...
    engineBaseUrl: "https://www.duckduckgo.com/?q=",
    excludedSites: [""],
  },
  time: {
  ...
  dock: {
    enabled: true,
    hiddenThickness: 5,
    pinnedApps: ['systemsettings','zen-browser','gnome-system-monitor','org.gnome.Nautilus','spotify','com.obsproject.Studio','freetube','code-oss','beeper','obsidian','stremio','materialgram','vesktop','libreoffice-writer',],
    layer: "top",
